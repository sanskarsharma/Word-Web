...
public class Fourth2 extends Activity implements AnimationListener {
	...
	String array[]={"A","E","S","N","X","A","G","A","D","R","S","Y","P","E","R","A","T","E","D"};
	String str;
	...
	public void levelreset()
	{
		...
		for(int i=0;i<ko;i++)
		{
			Fourth2.this.viewarray[i].setVisibility(View.VISIBLE);
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LevelsToPlay.level4.setEnabled(true);
		
		storage= new String[5];
		storage[0]= "ANGRY";
		storage[1]= "SAD";
		storage[2]= "EXASPERATED";
		...
		NextLevel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent lev2 = new Intent(Fourth2.this,Fifth2.class);
				startActivity(lev2);
				Fourth2.this.overridePendingTransition(R.anim.slideopen, R.anim.slideclose);
			}
		});
		...
		gv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				del.setEnabled(true);
				Fourth2.this.viewarray[ko]=view;  // this is to store views in an array on itemclick so that can be used in level reset
				ko++;
