...
public class Sixth2 extends Activity implements AnimationListener {
	...
	String array[]={"G","C","P","R","O","L","A","M","A","V","E","N","I","T","E","T","T","Y"};
	String str;
	...
	public void levelreset()
	{
		...
		for(int i=0;i<ko;i++)
		{
			Sixth2.this.viewarray[i].setVisibility(View.VISIBLE);
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LevelsToPlay.level6.setEnabled(true);
		...
		NextLevel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent lev2 = new Intent(Sixth2.this,Seventh2.class);
				startActivity(lev2);
				Sixth2.this.overridePendingTransition(R.anim.slideopen, R.anim.slideclose);
			}
		});
		...
		gv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				del.setEnabled(true);
				Sixth2.this.viewarray[ko]=view;  // this is to store views in an array on itemclick so that can be used in level reset
				ko++;
