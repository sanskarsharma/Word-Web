...
public class First_level extends Activity implements AnimationListener {
	...
	String array[]={"D","P","K","A","O","R","H","R","A","O","S","P"};
	String str;
	...
	public void levelreset()
	{
		...
		for(int i=0;i<ko;i++)
		{
			First_level.this.viewarray[i].setVisibility(View.VISIBLE);
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		NextLevel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent lev2 = new Intent(First_level.this,Second2.class);
				startActivity(lev2);	
				First_level.this.overridePendingTransition(R.anim.slideopen, R.anim.slideclose);
		...
		gv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				del.setEnabled(true);
				First_level.this.viewarray[ko]=view;  // this is to store views in an array on itemclick so that can be used in level reset
				ko++;
