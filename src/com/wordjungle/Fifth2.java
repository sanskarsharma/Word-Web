...
public class Fifth2 extends Activity implements AnimationListener {
	...
	String array[]={"C","H","W","O","E","E","C","R","E","A","O","D","I","I","N","N","E","E"};
	String str;
	...
	public void levelreset()
	{
		...
		for(int i=0;i<ko;i++)
		{
			Fifth2.this.viewarray[i].setVisibility(View.VISIBLE);
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LevelsToPlay.level5.setEnabled(true);
		...
		NextLevel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent lev2 = new Intent(Fifth2.this,Sixth2.class);
				startActivity(lev2);
				Fifth2.this.overridePendingTransition(R.anim.slideopen, R.anim.slideclose);
			}
		});
		...
		gv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				del.setEnabled(true);
				Fifth2.this.viewarray[ko]=view;  // this is to store views in an array on itemclick so that can be used in level reset
				ko++;
