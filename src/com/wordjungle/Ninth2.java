...
public class Ninth2 extends Activity implements AnimationListener {
	...
	String array[]={"M","R","T","A","A","R","L","N","O","W","S","J","A","O","A","R","M","N","E","W","A","R","E"};
	String str;
	...
	public void levelreset()
	{
		...
		for(int i=0;i<ko;i++)
		{
			Ninth2.this.viewarray[i].setVisibility(View.VISIBLE);
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LevelsToPlay.level9.setEnabled(true);
		
		storage= new String[5];
		storage[0]= "TROJAN";
		storage[1]= "RANSOMWARE";
		storage[2]= "MALWARE";
		...
		NextLevel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent lev2 = new Intent(Ninth2.this,LevelsToPlay.class);
				startActivity(lev2);
				Toast.makeText(getApplicationContext(), "CONGRATULATIONS!!! You Unlocked Every Theme! New Themes Update Coming Soon!", Toast.LENGTH_LONG).show();
				Ninth2.this.overridePendingTransition(R.anim.slideopen, R.anim.slideclose);
			}
		});
		...
		gv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				del.setEnabled(true);
				Ninth2.this.viewarray[ko]=view;  // this is to store views in an array on itemclick so that can be used in level reset
				ko++;
