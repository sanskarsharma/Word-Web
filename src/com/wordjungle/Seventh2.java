...
public class Seventh2 extends Activity implements AnimationListener {
	...
	String array[]={"M","D","P","I","O","O","N","R","P","I","E","E","O","M","Y","N","O","E","N","A"};
	String str;
	...
	public void levelreset()
	{
		...
		for(int i=0;i<ko;i++)
		{
			Seventh2.this.viewarray[i].setVisibility(View.VISIBLE);
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LevelsToPlay.level7.setEnabled(true);
		...
		NextLevel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent lev2 = new Intent(Seventh2.this,Eighth2.class);
				startActivity(lev2);
				Seventh2.this.overridePendingTransition(R.anim.slideopen, R.anim.slideclose);
			}
		});
		...
		gv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				del.setEnabled(true);
				Seventh2.this.viewarray[ko]=view;  // this is to store views in an array on itemclick so that can be used in level reset
				ko++;
